...
const faqs = [
  {
    ...
    answer: "oyaboug connecte les commerces ayant des invendus avec les consommateurs. Vous pouvez réserver des paniers surprises à prix réduits et les récupérer dans les créneaux indiqués.",
  },
  {
  ...
  },
  {
    ...
    answer: "oyaboug prélève une petite commission sur chaque vente réalisée. Cela nous permet de maintenir et développer la plateforme tout en restant accessible à tous.",
  },
];
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Tout ce que vous devez savoir sur oyaboug.
          </p>
        </motion.div>
