      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-green max-w-none space-y-6 text-muted-foreground">
          <section>
            ...
            <p>Les présentes conditions générales régissent l'utilisation de la plateforme SaveFood, service de lutte contre le gaspillage alimentaire au Gabon.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-foreground">2. Inscription</h2>
            <p>L'utilisation de SaveFood nécessite la création d'un compte. L'utilisateur s'engage à fournir des informations exactes et à maintenir la confidentialité de ses identifiants.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-foreground">3. Services</h2>
            <p>SaveFood permet aux commerçants de proposer des produits à prix réduits et aux consommateurs d'acheter ces produits. Les transactions sont effectuées directement entre les parties.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-foreground">4. Responsabilités</h2>
            <p>SaveFood agit en tant qu'intermédiaire. Les commerçants sont responsables de la qualité et de la conformité des produits proposés.</p>
          </section>
          ...
          <section>
            ...
            <p>Pour toute question, contactez-nous à support@savefood.ga</p>
          </section>
        </div>
      </div>
    </div>
