...
const comparison = [
  { feature: "Accès instantané aux invendus", savefood: true, others: false },
  { feature: "Géolocalisation en temps réel", savefood: true, others: true },
  { feature: "Paiement mobile money", savefood: true, others: false },
  { feature: "Paniers gratuits solidaires", savefood: true, others: false },
  { feature: "Statistiques d'impact", savefood: true, others: false },
  { feature: "Support local 24/7", savefood: true, others: false },
];
      ...
      <main className="pt-24 pb-12">
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-8">
                ...
                SaveFood connecte les commerces et les consommateurs pour donner une seconde vie à ces produits.
              </p>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
                Pourquoi choisir <span className="text-gradient">SaveFood</span> ?
              </h2>
            </motion.div>
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-border">
                        ...
                        <th className="p-4 font-medium text-primary">SaveFood</th>
